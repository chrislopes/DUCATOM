...
export function DashboardNavigation({ hasBookings }: DashboardNavigationProps) {
        ...
        <nav className="space-y-4">
            {user?.role === 'MENTOR' && (
                <>
                    ...
                    <Button
                        className="w-full bg-[#0a5491] hover:bg-[#0d6bb8] text-white font-semibold text-base md:text-lg py-6 md:py-7 rounded-lg cursor-pointer transition-colors"
