...
import { X, Clock, User, GraduationCap } from 'lucide-react';
import { useEffect } from 'react';

interface ReservedSlotModalProps {
    isOpen: boolean;
    onClose: () => void;
    mentorName: string;
    studentName: string;
                ...
                <div className="p-6 space-y-5">
                    <div className="space-y-4">
                        <div className="flex items-start gap-3 p-4 bg-[#083d71]/40 rounded-lg border border-[#0a4d8f]/30">
                            <div className="w-10 h-10 rounded-full bg-[#f0e087]/20 flex items-center justify-center shrink-0">
                                <GraduationCap className="w-5 h-5 text-[#f0e087]" />
                            </div>
                        ...
                        <div className="flex items-start gap-3 p-4 bg-[#083d71]/40 rounded-lg border border-[#0a4d8f]/30">
                            <div className="w-10 h-10 rounded-full bg-[#f0e087]/20 flex items-center justify-center shrink-0">
                                <User className="w-5 h-5 text-[#f0e087]" />
                            </div>
                            <div className="flex-1">
                                <p className="text-xs text-gray-400 mb-1">
                                    Aluno
